...
class MySet(Dataset):
    ...
    def __getitem__(self, item):
        ...
        preimgraw = sitk.ReadImage(
            '/home/konata/Dataset/TAO_CT/ztf_CT/origin50' + "/" + midname)
        preimg = sitk.GetArrayFromImage(preimgraw)
        labelraw = sitk.ReadImage('/home/konata/Dataset/TAO_CT/ztf_CT/seg50' + "/" + midname)
        # labelraw = sitk.ReadImage('/media/dell/SATA1/dataset/CT/982seg' + "/" + midname)
